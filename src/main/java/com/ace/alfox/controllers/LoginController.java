...
public class LoginController {
    ...
    public ResponseEntity login(@RequestParam String user, HttpServletRequest request) {
        ...
        // TODO: Lookup `Player` for given authenticated user and set the `pid` (PlayerId) in the active session.

        // For now because we don't have a user database yet, just use the first 8 bytes of the username as the playerId
